#
# this work is based on greg bayer's GAE python implementation for GCM
#
# https://github.com/gregbayer/gae-python-gcm
#
# the next block already belongs to the project aforementioned
#
