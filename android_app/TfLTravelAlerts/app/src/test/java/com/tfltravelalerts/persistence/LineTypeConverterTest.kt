...
class LineTypeConverterTest {
    ...
    fun testLinesConverterToInt() {
        ...
        assertEquals(0b100000000000000, LineTypeConverter.linesConverter(setOf(Line.TRAM)))
    }
    ...
    fun testLinesConverterFromIntSingle() {
        ...
        assertEquals(setOf(Line.TRAM), LineTypeConverter.linesConverter(16384))
    }
    ...
    fun testLinesConverterFromIntMulti() {
        ...
        assertEquals(setOf(Line.TRAM, Line.DLR), LineTypeConverter.linesConverter(20480))
